...
#make ~oacis/.ssh/config
$HOME/mk_ssh_config.sh ${KUSER}
chown oacis:oacis $HOME/.ssh/config
chmod 600 $HOME/.ssh/config

#make ~oacis/oacis_start.sh
$HOME/mk_oacis_start.sh
chown oacis:oacis $HOME/oacis_start.sh
chmod +x $HOME/oacis_start.sh
